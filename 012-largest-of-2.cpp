...
int main()
{
  ...
  if(number1>number2)
  {
    cout << number1 << " is the Largest Number "<< endl;  //Checking if Number1 is greater than Number2. If True, Displays the Result
  }
  else if(number2>number1)
  {
    cout << number2 << " is the Largest Number " << endl; //Checking if Number2 is greater than Number1. If True, Displays the Result
  }
  else
  {
